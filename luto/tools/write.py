...
def write_water(data: Data, yr_cal, path):
    ...
    ag_w_mrj_base_yr = ag_water.get_water_net_yield_matrices(data, yr_idx, data.WATER_YIELD_HIST_DR,
                                                             data.WATER_YIELD_HIST_SR)
    non_ag_w_rk_base_yr = non_ag_water.get_w_net_yield_matrix(data, ag_w_mrj_base_yr, data.lumaps[yr_cal], yr_idx,
                                                              data.WATER_YIELD_HIST_DR, data.WATER_YIELD_HIST_SR)
    ...
    df_water_limits_and_public_land.to_csv(os.path.join(path, f'water_yield_limits_and_public_land_{yr_cal}.csv'),
                                           index=False)
    ...
    df_water_seperate['Water_supply'] = df_water_seperate['Water_supply'].replace(
