...
def solve_timeseries(data: Data, years_to_run: list[int], analyze_iis_flag:bool=True) -> None:
    ...
    for step in range(len(years_to_run) - 1):
        ...
        if analyze_iis_flag and (luto_solver.gurobi_model.Status not in [GRB.OPTIMAL, GRB.SUBOPTIMAL]):
            print('!' * 100)
