...
food_ag_group_dict,legend_colors = get_colors(food_ag_group_dict, 'tools/land use colors.xlsx', sheet_name='ag_group')
output_png = '../output/09_food_ag_group'
y_range, y_ticks = calculate_y_axis_range(food_ag_group_dict)
plot_Combination_figures(food_ag_group_dict, output_png, input_files, plot_stacked_bar, legend_colors,
                            n_rows=3, n_cols=3, font_size=font_size, x_range=(2010, 2050), y_range=y_range,
                             x_ticks=20, y_ticks=y_ticks,
...
y_range, y_ticks = (-1,50),[0,10,20,30,40,50]
