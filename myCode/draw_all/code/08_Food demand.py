...
Product_demand_dict = get_dict_sum_data(input_files, "quantity_production_kt_separate", 'Prod_targ_year (tonnes, KL)', 'Production')
point_dict = concatenate_dicts_by_year([Objective_demand_dict, Product_demand_dict])
point_colors = ['red','black']

csv_name, value_column_name, filter_column_name = "quantity_production_kt_separate", 'Prod_targ_year (tonnes, KL)', 'Commodity'
