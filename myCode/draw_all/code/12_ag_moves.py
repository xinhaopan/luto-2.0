...
def plot_land_use_shift(input_file):
    ...
    labels = ['North (km)', 'Northeast', 'East', 'Southeast', 'South', 'Southwest', 'West', 'Northwest']
    ...
    output_file = f"../output/12_{input_file}_move.pdf"
    fig.savefig(output_file, dpi=300, bbox_inches='tight')
    plt.show()

Parallel(n_jobs=-1)(
    delayed(plot_land_use_shift)(input_file) for input_file in input_files
)