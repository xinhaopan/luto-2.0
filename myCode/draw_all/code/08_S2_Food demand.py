...
y_range, y_ticks = calculate_y_axis_range(demand_ag_group_dict)
plot_Combination_figures(demand_ag_group_dict, output_png, input_files, plot_stacked_area, legend_colors,
