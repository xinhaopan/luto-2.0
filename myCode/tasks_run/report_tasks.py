...
tasks = ['20250912_Price_Task_RES13_year5']
...
for task in tasks:
    ...
    create_task_runs(task_root_dir, grid_search_settings_df, platform, n_workers=min(len(grid_search_settings_df.columns), 4),use_parallel=True,model_name='Report')
