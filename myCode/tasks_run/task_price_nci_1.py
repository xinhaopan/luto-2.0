...
grid_search = {
    'TASK_NAME': ['20250901_Price_Task_NCI'],
...
# grid_search_settings_df = grid_search_settings_df[input_files]
# grid_search_settings_df = grid_search_settings_df.drop(columns=input_files)

grid_search_settings_df.to_csv(os.path.join(task_root_dir, 'grid_search_template.csv'),index=False)
