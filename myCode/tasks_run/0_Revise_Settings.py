...
suffixs = ['GHG_LIMITS_FIELD', 'BIODIV_GBF_TARGET_2_DICT','OBJECTIVE']

output_file = os.path.join("Custom_runs", "setting_0405_10.csv")
create_grid_search_template( grid_search,output_file,suffixs,'20240405')
