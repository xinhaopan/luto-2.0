...
grid_search = {
    'TASK_NAME': ['20260712_Paper3_test_RF10'],
    'KEEP_OUTPUTS': [False],
    'QUEUE': ['normalsr'],
    ...
    # Quick validation run at RESFACTOR=10: 12 CPUs / 32 GB.
    # NOTE: RESFACTOR must be 1-10 -- BIODIVERSITY_GBF4_TARGET_{ECNES,SNES}.csv only
    # contain rows for resfactor 1..10, so RF=15 crashes in Data() with KeyError 'COMMUNITY'.
    # Scenario config is IDENTICAL to the RF5 aquila run -- only the resolution differs.
    'MEM': ['32GB'],
    'NCPUS': ['12'],
