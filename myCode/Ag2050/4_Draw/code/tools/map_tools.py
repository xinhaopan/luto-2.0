...
def draw_proportion_maps(overlay_geo_tif, output_png, legend_png_name, cfg):
    intermediate_files = cfg.get_intermediate_files()
    ...
    # 3. 给叠加图分配颜色
    assign_color_by_area_ratio(cfg.overlay_reproject_geo_tif,  cfg.overlay_reproject_rgb_tif, write_png=cfg.write_png)
