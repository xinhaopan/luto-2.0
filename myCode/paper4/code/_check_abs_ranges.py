import pandas as pd
f = r'F:\Users\s222552331\Work\LUTO2_XH\luto-2.0\output\20260429_paper4_NCI\paper4\data\7_Average_Net_Cost_raw_data_2025_abs.xlsx'
...
for panel in ['Carbon', 'Biodiversity']:
    ...
    print(f'  ContributionWidth: total={sub.ContributionWidth.sum():.2f}')
