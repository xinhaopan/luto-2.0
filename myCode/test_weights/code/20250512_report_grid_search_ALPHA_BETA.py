...
task_root_dir = "../../../output/BEAT_test_demand_production"
...
df_demand_avg = df_demand.eval('val = abs(val)'
    ).groupby(['year',  'SOLVE_WEIGHT_BETA'] # 'GHG_EMISSIONS_LIMITS', 'BIODIVERSTIY_TARGET_GBF_2', 'SOLVE_WEIGHT_ALPHA',
...
fig = px.scatter(
    ...
    facet_col='GHG_EMISSIONS_LIMITS_profit',
...
p_weight_vs_profit = (
    ...
    p9.facet_wrap('GHG_EMISSIONS_LIMITS') +
    p9.geom_line(size=0.3) +
    p9.theme_bw() +
    p9.theme(
        strip_text=p9.element_text(size=8)
