...
from myCode.carbonprice import desc
...
def apply_sum_on_files_with_prefix(path_dir, file_prefix):
    ...
    combined_dict = {
        'cost_am': desc.cost_dict.get('cost_am', []),
        'cost_non_ag': desc.cost_dict.get('cost_non_ag', []),
        'revenue_am': desc.revenue_dict.get('revenue_am', []),
        'revenue_non_ag': desc.revenue_dict.get('revenue_non_ag', [])
    }
