...
rename_dict = {
    ...
    '04_xr_total_carbon': 'Figure 04 Difference in GHG emissions',
    '04_xr_total_bio': 'Figure 05 Difference in Biodiversity',
    ...
    '04_xr_transition_cost_ag2non_ag_amortised_diff': 'Figure S13 Difference in Transition(ag→non-ag) cost',
    '04_xr_GHG_ag_management': 'Figure S14 Difference in GHG emissions from agricultural management',
    '04_xr_GHG_non_ag': 'Figure S15 Difference in GHG emissions from non-agriculture',
    '04_xr_biodiversity_GBF2_priority_ag_management': 'Figure S16 Difference in Biodiversity from agricultural management',
    '04_xr_biodiversity_GBF2_priority_non_ag': 'Figure S17 Difference in Biodiversity from non-agriculture',
    ...
    '06_GHG_maps_line': 'Figure S20 Difference in Non-agricultural GHG emissions maps',
    '06_BIO_maps_line': 'Figure S21 Difference in Non-agricultural Biodiversity maps',
