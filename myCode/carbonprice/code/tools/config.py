...
ORIGINAL_TITLE_MAP = {'Run_18_GHG_off_BIO_off_CUT_50': 'Reference',
                'Run_12_GHG_low_BIO_off_CUT_50': r'$\mathrm{NZ}_{\mathrm{low}}$',
                'Run_06_GHG_high_BIO_off_CUT_50': r'$\mathrm{NZ}_{\mathrm{high}}$',

                'Run_11_GHG_low_BIO_high_CUT_10': r'$\mathrm{NZ}_{\mathrm{low}}$,$\mathrm{NP}_{\mathrm{10}}$',
                'Run_10_GHG_low_BIO_high_CUT_20': r'$\mathrm{NZ}_{\mathrm{low}}$,$\mathrm{NP}_{\mathrm{20}}$',
                'Run_09_GHG_low_BIO_high_CUT_30': r'$\mathrm{NZ}_{\mathrm{low}}$,$\mathrm{NP}_{\mathrm{30}}$',
                'Run_08_GHG_low_BIO_high_CUT_40': r'$\mathrm{NZ}_{\mathrm{low}}$,$\mathrm{NP}_{\mathrm{40}}$',
                'Run_07_GHG_low_BIO_high_CUT_50': r'$\mathrm{NZ}_{\mathrm{low}}$,$\mathrm{NP}_{\mathrm{50}}$',

                'Run_05_GHG_high_BIO_high_CUT_10': r'$\mathrm{NZ}_{\mathrm{high}}$,$\mathrm{NP}_{\mathrm{10}}$',
                'Run_04_GHG_high_BIO_high_CUT_20': r'$\mathrm{NZ}_{\mathrm{high}}$,$\mathrm{NP}_{\mathrm{20}}$',
                'Run_03_GHG_high_BIO_high_CUT_30': r'$\mathrm{NZ}_{\mathrm{high}}$,$\mathrm{NP}_{\mathrm{30}}$',
                'Run_02_GHG_high_BIO_high_CUT_40': r'$\mathrm{NZ}_{\mathrm{high}}$,$\mathrm{NP}_{\mathrm{40}}$',
                'Run_01_GHG_high_BIO_high_CUT_50': r'$\mathrm{NZ}_{\mathrm{high}}$,$\mathrm{NP}_{\mathrm{50}}$',
                }
