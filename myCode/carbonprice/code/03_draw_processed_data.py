...
GHG_FILES = {"xr_total_carbon", "xr_GHG_ag_management", "xr_GHG_non_ag"}
...
for spec in plot_specs:
    input_file, sheet_name, scale, ylabel, column_spacing, total_name, negative = (
        spec.file, spec.sheet, spec.scale, spec.ylabel, spec.column_spacing, spec.total_name, spec.negative
    )
    data_dict = xarray_to_dict(f"{input_dir}/{input_file}.nc", scale, total_name=total_name, negative=negative)
