...
draw_22_price(df4, config.PRICE_TITLE_MAP,output_path=f"{output_dir}/05_Carbon_solution_price_all.png", desired_ticks=5,  y_label=r"Shadow carbon price (AU\$ tCO$_2$e$^{-1}$ yr$^{-1}$)",ci=95)

set_plot_style(20)
df5 = df1.iloc[:, 2:]
draw_10_price(df5,config.PRICE_TITLE_MAP,color,f"{output_dir}/05_biodiversity_solution_price.png",desired_ticks=5,ylabel="Biodiversity price (AU\$ contribution-weighted area ha$^{-1}$ yr$^{-1}$)",ci=95)