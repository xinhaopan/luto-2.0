...
draw_10_price(df2,config.PRICE_TITLE_MAP,color,f"{output_dir}/05_Carbon_price_for_bio&carbon.png",desired_ticks=5,ci=None)
draw_10_price(df3,config.PRICE_TITLE_MAP,color,f"{output_dir}/05_Carbon_price_for_bio.png",desired_ticks=5,ylabel=r"Carbon price for biodiversity (AU\$ tCO$_2$e$^{-1}$ yr$^{-1}$)",ci=None)
