...
def save_legend(ax, output_legend_file='02_Food_legend.png'):
...
draw_plot_lines(df_filtered, colors, 'GHG Emissions (Mt CO2e)', (-300, 100), 100, "02_GHG_limit.png", font_size=font_size)
...
dram_coloum(demand_data, colors, '02_Food_demand.png', fontsize=font_size, y_range=(0, 200), y_tick_interval=50, ylabel='Food Demand (million tonnes/kilolitres [milk])')
...
colors = ['#E74C3C', '#3498DB', '#2ECC71']  # 根据数据列数调整颜色列表
draw_plot_lines(df, colors, 'Quality-weighted Area (Million ha)', (0, 120), 40, "02_biodiversity_limit.png", font_size=font_size)
...
colors = generate_colors(num_columns)
dram_coloum(dd_water_limit_df, colors, '02_water_limit.png', fontsize=font_size, y_range=(0, 300), y_tick_interval=100, ylabel='Water limit (Billion L)')
