...
csv_name, filter_column_name, value_column_name = 'GHG_emissions_separate_agricultural_management', 'Agricultural Management Type', 'Value (t CO2e)'
...
output_png = '13_GHG agricultural management area.png'
...
plot_Combination_figures(am_dict, output_png=output_png, input_names=input_files, plot_func=plot_stacked_bar,
                         ...
                         x_range=(2010, 2050), y_range=(-80, 0),
                         x_ticks=10, y_ticks=20, x_label='Year', y_label='GHG Emission (Mt CO2e)',
