...
output_png = '16_Biodiversity agricultural land.png'
...
plot_Combination_figures(merged_dict, output_png=output_png, input_names=input_files, plot_func=plot_stacked_bar,
                         ...
                         x_range=(2010, 2050), y_range=(0, 105),
                         x_ticks=10, y_ticks=35, x_label='Year', y_label='Quality-weighted Area (Million ha)',
